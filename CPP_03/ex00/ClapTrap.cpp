...
/*   Updated: 2023/08/23 11:56:52 by tlukanie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Constructor
ClapTrap::ClapTrap(): name("DirtyWilly"), hitPoints(10), energyPoints(10), attackDamage(0)
{
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap Deconstructor for " << name << " was called" << std::endl;
}
